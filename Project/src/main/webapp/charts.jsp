...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="<%=request.getContextPath() %>/resource/startbootstrap/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<%=request.getContextPath() %>/resource/startbootstrap/js/demo/chart-area-demo.js"></script>
    <script src="<%=request.getContextPath() %>/resource/startbootstrap/js/demo/chart-pie-demo.js"></script>
    <script src="<%=request.getContextPath() %>/resource/startbootstrap/js/demo/chart-bar-demo.js"></script>
